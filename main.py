    ...
    for key in bodypart:
        ...
        if "left_eye" in key:
            for zone in left_eye:
                tuxmodifier.modify("fff000", zone)
        if "right_eye" in key:
            for zone in right_eye:
                tuxmodifier.modify("ff0000", zone)
        if "beak" in key:
            for zone in beak:
                tuxmodifier.modify("ff00ff", zone)
        if "head" in key:
            for zone in head:
                tuxmodifier.modify("ffff00", zone)
        if "body" in key:
            for zone in body:
                tuxmodifier.modify("00ff00", zone)
        if "torso" in key:
            for zone in torso:
                tuxmodifier.modify("0000ff", zone)
        if "left_palm" in key:
            for zone in left_palm:
                tuxmodifier.modify("00ffff", zone)
        if "right_palm" in key:
